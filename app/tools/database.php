...
if (isset($result['user_version'])) {
    ...
    if ($result['user_version'] < 4) {
        $queries["Fix Error Match Irlande poule C - 1"] = "UPDATE match SET equipe_id_2 = 10 WHERE id IN (6, 17);";
        $queries["Fix Error Match Irlande poule C - 2"] = "UPDATE match SET equipe_id_1 = 10 WHERE id = 30;";
    }
